...
socket.on('allowreplay', function (data) {
  if (data === true) {
    ...
    allowreplay = true
    drawMenu(dropupContent.innerHTML + '<a id="credentialsBtn"><i class="fas fa-key fa-fw"></i> 访问凭证</a>')
  } else {
    allowreplay = false
    console.log('allowreplay: ' + data)
  }
...
socket.on('allowreauth', function (data) {
  if (data === true) {
    ...
    allowreauth = true
    drawMenu(dropupContent.innerHTML + '<a id="reauthBtn"><i class="fas fa-key fa-fw"></i> 切换用户</a>')
  } else {
    allowreauth = false
    console.log('allowreauth: ' + data)
  }
...
function toggleLog () { // eslint-disable-line
  if (sessionLogEnable === true) {
    ...
    loggedData = true
    logBtn.innerHTML = '<i class="fas fa-clipboard fa-fw"></i> 开启日志'
    ...
    loggedData = true
    logBtn.innerHTML = '<i class="fas fa-cog fa-spin fa-fw"></i> 关闭日志'
